...
namespace GME
{
	public class QAVError
	{
        ...
        public static int AV_ERR_DB_ERROR           = 7019;    // 数据库错误
        public static int AV_ERR_SYSTEM_INTERNAL_ERROR = 7020; // 系统内部错误
        public static int AV_ERR_INVALID_REQ        = 7021;    // 无效请求
        public static int AV_ERR_BUS_ERROR          = 7022;    // 业务不支持或者没有开通
        ...
        public static string GMESDK_VERSION_2_9_1_4127f5e0 = "2_9_1_4127f5e0";
        #endregion
    }
}