...
namespace GME
{
    ...
    public abstract class ITMGContext
	{
        ...
        public static string IENGINE_VERSION = QAVError.GMESDK_VERSION_2_9_1_4127f5e0;
        static ITMGContext(){         
            QAVSDKInit.InitSDK();
	...
	public abstract class ITMGPTT
	{
		...
		///  <param name="sourceLanguage">待翻译文本的语言，可为空</param>
        ///    <param name="translateLanguage">文本翻译后的语言，不可为空,
        ///                 以英文逗号作为间隔，如"cmn-Hans-CN,en-GB"、"cmn-Hans-CN"</param>
		/// <returns> if success return OK</returns>
        ...
        /// 文本转语音
        /// </summary>
        /// <param name="text">原始文本,不可为空，最大长度5000字符</param>
        /// <param name="voiceName">语音名称，可为空，例：“af-ZA-Standard-A”,
        ///                         支持列表 https://cloud.google.com/text-to-speech/docs/voices</param>
        /// <param name="languageCode">语言。不可为空，语言列表 https://cloud.tencent.com/document/product/607/30282</param>
        /// <param name="speakingRate">语速 范围[0.6-1.5]</param>
        /// <returns>成功返回OK</returns>
